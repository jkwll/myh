...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath }/admin/css/style_grey.css" />
<style>
input[type=text] {
	width: 80%;
	height: 25px;
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform"
						...
						<s:if test="#logincounter>1">
							<div id="codeInputLine" class="loginFormIpt showPlaceholder"
								...
								<input id="loginform:codeInput" class="loginFormTdIpt"
									...
									id="loginform:vCode"
									src="${pageContext.request.contextPath }/admin/validatecode.jsp"
					...
					<s:else>
						<div id="codeInputLine" class="loginFormIpt showPlaceholder"
							style="margin-left: 350px; margin-top: -40px; width: 50px;">
