		...
		<TBODY>
			<TR>
				<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
					<TR>
						<TD class=manageHead>当前位置：文章 &gt; 文章列表</TD>
					</TR>
					<TR>
						<TD height=2></TD>
					</TR>
						...
						<TR>
							<TD height=25>
								<FORM id="pageForm" name="customerForm"
									action="${pageContext.request.contextPath }/admin/essayadmin.action"
									method=post>
									<!-- 隐藏域.当前页码 -->
										...
										<TBODY>
											<TR>
												...
												<TD><INPUT class=textbox id=sChannel2
													style="WIDTH: 80px" maxLength=50 name="title"
									...
									<TBODY>
										...
										<s:iterator var="e" value="#pageBean.list" status="status">
											<TR
												...
												<TD width="5%"><s:property value="#e.essay_id" /></TD>
												<TD width="20%"><input type="text" name="content"
													value="<s:property value="#e.title" />"></TD>
												<TD width="18%"><input type="text" name="time"
													value="<s:property value="#e.introduction" />"></TD>
												<TD width="18%"><s:property value="#e.time" /></TD>
												<TD width="10%"><s:property value="#e.flag" /></TD>
												<TD><a
													href="${pageContext.request.contextPath }/admin/essayadmin.action?essay_id=<s:property value="#e.essay_id" />">修改</a>
												</TD>
											</TR>
										</s:iterator>
