...
<script type="text/javascript">
	...
	$(function() {
		...
		// 基本功能菜单加载
		$.ajax({
			url : '${pageContext.request.contextPath}/admin/json/menu.json',
			type : 'POST',
			dataType : 'text',
		...
		// 系统管理菜单加载
		$.ajax({
			url : '${pageContext.request.contextPath}/admin/json/admin.json',
			type : 'POST',
			dataType : 'text',
			success : function(data) {
				var zNodes = eval("(" + data + ")");
			...
			<tbody>
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">blog</div>
					</td>
